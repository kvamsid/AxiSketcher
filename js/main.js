...
var freehandSelected, polySelected, selectSelected, exploreCleared, lassoSelected, lassoCleared;

const ASTER_PLOT_MARGIN = { TOP: 30, RIGHT: 30, BOTTOM: 30, LEFT: 30 };
const ASTER_PLOT_WIDTH = 380 - ASTER_PLOT_MARGIN.LEFT - ASTER_PLOT_MARGIN.RIGHT,
  ASTER_PLOT_HEIGHT = 380 - ASTER_PLOT_MARGIN.TOP - ASTER_PLOT_MARGIN.BOTTOM;
...
function drawRadarNew(data1, data2) {
  ...
  var radar_data = [
    [
      ...
      { axis: "Govt. Integrity", value: data1.properties[1].value },
      { axis: "Judicial Eff.", value: data1.properties[2].value },
      { axis: "Tax Burden", value: data1.properties[3].value },
      { axis: "Govt. Spending", value: data1.properties[4].value },
    ...
    [
      ...
      { axis: "Govt. Integrity", value: data2.properties[1].value },
      { axis: "Judicial Eff.", value: data2.properties[2].value },
      { axis: "Tax Burden", value: data2.properties[3].value },
      { axis: "Govt. Spending", value: data2.properties[4].value },
  ...
  RadarChart("#Radar_1", radar_data, radarChartOptions, [data1.name, data2.name]);
  RadarChart("#Radar_2", radar_data, radarChartOptions, [data1.name, data2.name]);
}
...
function createTable(divId, dataPoints) {
  ...
  var table_data = [
    ["Country", "Property Rights", "Govt. Integrity",
      "Judicial Eff.", "Tax Burden", "Govt. Spending", "Fiscal Health",
      "Busi. Freedom", "Labor Freedom", "Monetary Freedom", "Trade Freedom"],
  ];
